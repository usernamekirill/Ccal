...
RECOGNITION_UNCERTAIN_TEXT = (
    "Сейчас не удалось собрать приём из этого сообщения.\n\n"
    "Напишите продукт и вес одной строкой, например:\n"
    "✍️ «гречка 200 г» или «200 г гречки»\n"
    "или отправьте фото / голосовое описание."
)

...
PHOTO_EDIT_NAME_TEXT = "Напиши: номер продукта и новое название. Например: 1 гречка"
PHOTO_EDIT_GRAMS_TEXT = "Напиши: номер продукта и граммы. Например: 1 120"
PHOTO_EDIT_CALORIES_TEXT = "Напиши: номер продукта и калории. Например: 1 250"
PHOTO_ADD_ITEM_TEXT = "Напиши: название, граммы, калории. Например: кофе с молоком, 250, 120"
PHOTO_DELETE_ITEM_TEXT = "Напиши номер продукта, который нужно удалить."
PHOTO_EDIT_ERROR_TEXT = "Не смог применить изменение. Проверь формат и попробуй еще раз."
...
TARGETS_CONFIRMED_TEXT = (
    "Готово, цель сохранена. Теперь можешь отправить фото еды, текст или голосовое уточнение."
)

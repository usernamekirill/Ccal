...
RECOGNITION_UNCERTAIN_TEXT = (
    "Давай чуть конкретнее — например с весом или одной фразой про блюдо ✍️\n\n"
    "Можно так: «гречка 200 г» или просто фото / голос."
)
TEXT_FOOD_PROCESSING_TEXT = "Разбираю, что добавить в дневник ✍️"
TEXT_FOOD_CLARIFICATION_PREFIX = "Давай уточним 👇"
